...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Institute Setup'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="col-xs-12">
  <div class="col-lg-8 col-sm-8 col-xs-12 no-padding edusecArLangCss"><h3 class="box-title"><i class="fa fa-search"></i> <?php echo Yii::t('app', 'View Institute Setup Details') ?></h3></div>
  <div class="col-lg-4 col-sm-4 col-xs-12 no-padding" style="padding-top: 20px !important;">
	<div class="col-xs-4 left-padding edusecArLangHide">
    
	</div>
	<div class="col-xs-4 edusecArLangHide">
       
	</div>
	<div class="col-xs-4">
         <?= Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->org_id], ['class' => 'btn btn-info']) ?>
	</div>
   </div>
</div>
