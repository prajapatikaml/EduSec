...
?>
<div class="col-xs-12">
  <div class="col-lg-8 col-sm-8 col-xs-12 no-padding"><h3 class="box-title"><i class="fa fa-search"></i> <?php echo Yii::t('app', 'View Institute Setup Details') ?></h3></div>
  <div class="col-lg-4 col-sm-4 col-xs-12 no-padding" style="padding-top: 20px !important;">
	...
	<div class="col-xs-4 ">
         <?= Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->org_id], ['class' => 'btn btn-block btn-info']) ?>
	</div>
   </div>
</div>
