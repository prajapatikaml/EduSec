...
<div class="row">
  <div class="col-xs-12 col-md-12 col-lg-12">
	<div class="col-md-4 col-xs-4 edusec-profile-label edusecArLangCss"><?= $model->getAttributeLabel('stu_master_course_id') ?></div>
...
<div class="row">
  <div class="col-xs-12 col-md-12 col-lg-12">
	<div class="col-md-4 col-xs-4 edusec-profile-label edusecArLangCss"><?= $model->getAttributeLabel('stu_master_batch_id') ?></div>
...
<div class="row">
  <div class="col-xs-12 col-md-12 col-lg-12">
	<div class="col-md-4 col-xs-4 edusec-profile-label edusecArLangCss"><?= $model->getAttributeLabel('stu_master_section_id') ?></div>
...
<div class="row">
  <div class="col-xs-12 col-md-12 col-lg-12 col-md-12 col-lg-12">
	<div class="col-md-4 col-xs-4 edusec-profile-label edusecArLangCss"><?= $info->getAttributeLabel('stu_admission_date') ?></div>
...
<div class="row">
  <div class="col-xs-12 col-md-12 col-lg-12">
	<div class="col-md-4 col-xs-4 edusec-profile-label edusecArLangCss"><?= $model->getAttributeLabel('stu_master_stu_status_id') ?></div>
...
<div class="row">
  <div class="col-xs-12 col-md-12 col-lg-12">
	<div class="col-md-4 col-xs-4 edusec-profile-label edusecArLangCss"><?= $model->getAttributeLabel('is_status') ?></div>
