...
<div class="row">
  <div class="col-xs-12">
	...
	<div class="pull-right"><?= Html::a('<i class="fa fa-pencil-square-o"></i> '.Yii::t('emp', 'Edit'), ['update', 'empid' => $model->emp_master_id, 'tab' => 'otherinfo'], ['class' => 'btn btn-primary btn-sm', 'id' => 'update-data']) ?></div>
	<?php } ?>
	</h2>
  </div><!-- /.col -->
</div>
