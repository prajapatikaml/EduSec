...
class <?php echo $this->controllerClass; ?> extends RController
{
	/**
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
              ...
              if(isset($session['<?php echo $this->modelClass; ?>_records']))
               {
                $d=$_SESSION['<?php echo $this->modelClass; ?>_records'];
		 $model = array();
		...
		Yii::app()->request->sendFile("<?php echo $this->modelClass; ?>.xlsx",
