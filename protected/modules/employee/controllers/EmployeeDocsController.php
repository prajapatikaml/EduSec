...
class EmployeeDocsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['EmployeeDocs'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->employee_docs_id));
		}
...
/*		$dataProvider=new CActiveDataProvider('EmployeeDocs');
		...
		if(isset($_GET['EmployeeDocs']))
			$model->attributes=$_GET['EmployeeDocs'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='employee-docs-form')
		{
