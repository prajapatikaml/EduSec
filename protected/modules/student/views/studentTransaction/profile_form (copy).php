		...
		<?php $studInfo = StudentTransaction::model()->findByPk($_REQUEST['id']); 
			...
			<div class="email-display" style="color:#1EA076"><i class="fa fa-graduation-cap"></i> Course : <?php echo (!empty($studInfo->Rel_course->course_name) ? $studInfo->Rel_course->course_name : "Not Set");?></div>
                        <div class="email-display"><i class="fa fa-sitemap"></i> Batch : <?php echo (!empty($studInfo->Rel_Batch->batch_name) ? $studInfo->Rel_Batch->batch_name : "Not Set");?></div>
			...
			<?php } ?>
                ...
                <div class="profile-tab-he">                	
                	<ul class="pronav nav-tabs">
                      <li class="activetab"><a href="#tab1">Profile</a></li>
                      <li><a href="#tab2">Academic Info</a></li>
                      <li><a href="#tab3">Guardian Info</a></li>
		      <li><a href="#tab5">Address Info</a></li>
                    ...
                    <div class="content-box-border">
                        ...
                        <div class="content-bg-inner">
                            <div class="content-bg-inner-one">
                                <table width="100%" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td class="table-cell-title" width="23%">Student No.</td>
                                    <td class="table-cell-content" width="23%"><?php echo (!empty($studInfo->Rel_Stud_Info->student_roll_no) ? $studInfo->Rel_Stud_Info->student_roll_no : "Not Set") ;?></td>
                                    <td class="table-cell-title" width="23%">Course</td>
                                    <td class="table-cell-content" width="23%"><?php echo (!empty($studInfo->Rel_course->course_name) ? $studInfo->Rel_course->course_name : "Not Set");?>    </td>
                                  </tr>
                                  <!--tr>
                                    <td class="table-cell-title">Semester</td>
                                    <td class="table-cell-content"><?php //echo (!empty($studInfo->Rel_student_academic_terms_name->academic_term_name) ? $studInfo->Rel_student_academic_terms_name->academic_term_name : "Not Set");?> </td>
                                    <td class="table-cell-title">Year</td>
                                    <td class="table-cell-content"><?php //echo (!empty ($studInfo->Rel_student_academic_terms_period_name->academic_term_period) ? $studInfo->Rel_student_academic_terms_period_name->academic_term_period : "Not Set ");?></td>
                                  </tr-->
                                  <tr>
                                    <td class="table-cell-title">Batch</td>
                                    <td class="table-cell-content"><?php echo (!empty($studInfo->Rel_Batch->batch_name) ? $studInfo->Rel_Batch->batch_name : "Not Set"  );?></td>
                                  </tr>
                                </table>
                            </div>
                        </div>
