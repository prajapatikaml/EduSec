...
{
   echo CHtml::link('GO BACK',array('/student/attendence/studentAttendenceReport','id'=>$_REQUEST['id']));
}
else
{
echo CHtml::link('GO BACK',Yii::app()->createUrl('student/attendence/studentwise_report'));
