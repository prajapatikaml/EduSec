...
class StudentAddressController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('StudentAddress');
	...
	{
		$model=new StudentAddress('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['StudentAddress']))
			$model->attributes=$_GET['StudentAddress'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='student-address-form')
		{
