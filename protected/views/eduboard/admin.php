...
<div class="portlet-title"><i class="fa fa-plus"></i><span class="box-title">Manage Education Boards</span>
</div>
<div class="operation">
<?php echo CHtml::link('<i class="fa fa-plus-square"></i>Add', array('eduboard/create'), array('class'=>'btn green'))?>
