...
<div class="portlet-title"><i class="fa fa-plus"></i><span class="box-title">Manage Qualification</span>
</div>
<div class="operation">
<?php echo CHtml::link('<i class="fa fa-plus-square"></i>Add', array('qualification/create'), array('class'=>'btn green'))?>
